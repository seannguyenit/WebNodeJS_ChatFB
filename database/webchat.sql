...
INSERT INTO `bill` (`id`, `created_by`, `time`, `group_id`, `stt`, `customer`, `u_id`, `accepted`, `accountant`, `reject`, `code`, `accepted_note`, `accountant_note`, `reject_note`, `money_receive`, `trade_code`) VALUES (100,10,'2021-10-17 23:22:11',0,2,'100017865601279',_binary '617c4a25-2f66-11',7,7,NULL,'nt1-0001',NULL,'kt',NULL,NULL,'a4z');
...
INSERT INTO `bill_details` (`id`, `product_id`, `quantity`, `bill_uid`, `price`, `ck`) VALUES (138,11,20.000,_binary '617c4a25-2f66-11',70000.000,10000.000),(139,12,15.000,_binary '617c4a25-2f66-11',50000.000,9.000);
...
INSERT INTO `chat_group` (`id`, `title`, `tags`, `user_ids`, `note`, `cus_id`, `acc_receive`, `fb_acc_send`, `fb_acc_send_name`, `pro_ids`) VALUES (26,'','2,3','19','','100017865601279',10,NULL,NULL,''),(27,'','3','15','','100004251633262',10,NULL,NULL,''),(28,'','1','','','100002977222859',10,NULL,NULL,''),(29,'','3','17','','100001113783887',10,NULL,NULL,'');
...
CREATE TABLE `chat_group_mess` (
  ...
  `mess_key` longtext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=641 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group` (`id`, `name`, `role_limits`) VALUES (1,'Nhóm Hà Nội 1','[{\"id\":\"1\",\"value\":\"1\"},{\"id\":\"2\",\"value\":\"1\"},{\"id\":\"3\",\"value\":\"1\"},{\"id\":\"5\",\"value\":\"1\"},{\"id\":\"6\",\"value\":\"100\"}]'),(2,'Nhóm Nha Trang',NULL),(3,'Nhóm Hà Nội 2',NULL);
...
INSERT INTO `group_product` (`id`, `group_id`, `product_id`, `ck`) VALUES (2,1,3,NULL);
...
INSERT INTO `menu_role` (`id`, `par_id`, `name`, `action`, `is_admin`, `order`) VALUES (376,354,'Báo cáo hàng hóa','report_product',0,2),(375,354,'Báo cáo đơn hàng','report_bill',0,1),(374,354,'Báo cáo tổng hợp','report_general',0,0),(373,353,'Xóa','delete',0,2),(372,353,'Sửa','edit',0,1),(371,353,'Thêm','new',0,0),(370,350,'Xóa','delete',0,2),(369,350,'Sửa','edit',0,1),(368,350,'Thêm','new',0,0),(367,355,'Xóa','delete',0,2),(366,355,'Sửa','edit',0,1),(365,355,'Thêm','new',0,0),(364,351,'Xóa','delete',0,2),(363,351,'Sửa','edit',0,1),(362,351,'Thêm','new',0,0),(361,NULL,'Xóa','delete',0,3),(360,NULL,'Sửa','edit',0,2),(359,NULL,'Thêm','new',0,1),(358,352,'Xóa','delete',0,3),(357,352,'Sửa','edit',0,2),(356,352,'Thêm','new',0,1),(355,0,'Tag Chat','tag_name',1,8),(353,0,'Sản phẩm','product',0,6),(354,0,'Báo cáo','report',0,7),(352,0,'Tài khoản','user',0,5),(351,0,'Nhóm kinh doanh','group',0,4),(350,0,'Chức vụ','role_type',0,3),(349,0,'Hộp thư','chat',0,2),(348,0,'Thông báo','notice',0,1);
...
INSERT INTO `money_count` (`id`, `money`, `user_id`, `bill_uid`, `is_active`, `del_by`, `time`) VALUES (10,10000.000,10,_binary '617c4a25-2f66-11',1,NULL,'2021-10-17 23:22:11');
...
INSERT INTO `product` (`id`, `name`, `code`, `is_active`, `price`, `group_id`, `ck_id`) VALUES (11,'ao thun','a-001',1,70000.000,1,_binary '7c0bb2ae-1c9d-11'),(12,'quan dui','q-001',1,50000.000,1,_binary '5fea0a3c-1d0c-11'),(13,'ao thun','a-002',1,60000.000,2,_binary '8271da4a-1d0c-11'),(14,'gi le','28478',1,12000.000,1,_binary 'a3d68c1a-2bfd-11');
...
INSERT INTO `role_type` (`id`, `name`, `level`) VALUES (1,'Kế Toán',0),(2,'Thủ Quỹ',0),(3,'CTV_T',0),(4,'admin',0),(5,'QTV',0),(6,'CTV_A',0);
...
INSERT INTO `tag_name` (`id`, `name`, `color`) VALUES (1,'go go','#14f01b'),(2,'Stop','#db0a0a'),(3,'OK','#cddb0a'),(4,'Next','#db6f0a');
...
-- Dump completed on 2021-10-18 10:04:58
